  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor: WidgetStateProperty.resolveWith((states) => WebColors.primary),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(WebSizes.borderRadiusMd)),
        ),
        // Set the decoration for the heading row of the data table
        headingRowDecoration: const BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(WebSizes.borderRadiusMd), topRight: Radius.circular(WebSizes.borderRadiusMd)),
        ),
      ),
    );
  }
