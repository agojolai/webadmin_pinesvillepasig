...
class TPaginatedDataTable extends StatelessWidget {
  const TPaginatedDataTable({
    ...
    this.dataRowHeight = WebSizes.xl * 2,
    ...
    return SizedBox(
      ...
      child: Theme(
        ...
        child: PaginatedDataTable2(
          ...
          headingRowColor: WidgetStateProperty.resolveWith((states) => WebColors.primaryBackground),
          empty: TAnimationLoaderWidget(animation: TImages.packageAnimation, text: 'Nothing Found', height: 200, width: 200),
          headingRowDecoration: const BoxDecoration(
            borderRadius: BorderRadius.only(
              topLeft: Radius.circular(WebSizes.borderRadiusMd),
              topRight: Radius.circular(WebSizes.borderRadiusMd),
            ),
          ),
