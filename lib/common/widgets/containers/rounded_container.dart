...
class TRoundedContainer extends StatelessWidget {
  ...
  const TRoundedContainer({
    ...
    this.padding = const EdgeInsets.all(WebSizes.md),
    this.borderColor = WebColors.borderPrimary,
    this.radius = WebSizes.cardRadiusLg,
    this.backgroundColor = WebColors.white,
    this.onTap,
  });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (showShadow)
              BoxShadow(
                color: WebColors.grey.withValues(alpha: 0.1),
                spreadRadius: 5,
                blurRadius: 8,
