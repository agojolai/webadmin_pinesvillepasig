                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: const [
                                ...
                                Expanded(child: Text("Phone Number", style: TextStyle(color: Colors.white))),
                                Expanded(child: Text("Unit No.", style: TextStyle(color: Colors.white))),
                                Expanded(child: Text("Move-in Date", style: TextStyle(color: Colors.white))),
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      final docId = tenants[index].id;

                                      final name = '${data['FirstName'] ?? 'Unknown'} ${data['LastName'] ?? 'Unknown'}';
                                                      ...
                                                      onPressed: () async {
                                                        final confirm = await showDialog<bool>(
                                                          ...
                                                          builder: (context) => AlertDialog(
                                                            ...
                                                            content: Text(
                                                              "Are you sure you want to approve $name's application?",
                                                        ...
                                                        if (confirm == true) {
                                                          ...
                                                          await FirebaseFirestore.instance.collection('Users').doc(docId).set(updatedData);
                                                      ...
                                                      onPressed: () async {
                                                        final confirm = await showDialog<bool>(
                                                          ...
                                                          builder: (context) => AlertDialog(
                                                            ...
                                                            content: Text(
                                                              "Are you sure you want to decline $name's application?",
                                                              style: const TextStyle(color: Colors.white70),
                                                            ),
                                                            actions: [
                                                              TextButton(
