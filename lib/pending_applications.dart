                ...
                Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 2),
                        Text('Manage your tenants or invite new tenants to your residence',
                          style: TextStyle(fontSize: 11, color: Color(0xFFA9A9A9), fontWeight: FontWeight.w100,),
                        ),
                        SizedBox(height: 10),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          // Title
                                          const Text("Pending Applications", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold,
                                          ),
                                          ),
                                          const SizedBox(height: 20),
                                          ...
                                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: const [
                                              ...
                                              Expanded(
                                                  child: Text("Unit No.", style: TextStyle(color: Colors.white))),
                                              Expanded(
                                                  child: Text("Move-in Date", style: TextStyle(color: Colors.white))),
                                              Expanded(
